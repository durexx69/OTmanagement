...
<div class="row">
    <div class="col-lg-12">                           
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-file-text"></i> รายงานสรุป </li>
        </ol>
    </div>
</div>
                                ...
                                <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                    ...
                                    <tbody>  
                                        ...
                                        <tr class="odd pointer">                                
                                            ...
                                            <td><a href="<?php echo site_url('report/detail_ot/' . $value['monthly'])  ?>" class="btn btn-success btn-xs">รายงานสรุปประจำเดือน</a>                                                              </td>
                                            </td>
                                        </tr>                                        
                                        <?php } ?>
                                    </tbody>
