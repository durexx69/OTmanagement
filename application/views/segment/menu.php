...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a href="<?php echo site_url('managedata_overtime/index') ?>"><i class="fa fa-clock-o"></i> บันทึกข้อมูล โอ.ที. </a></li>
            <li><a href="<?php echo site_url('view_approve/index') ?>"><i class="fa fa-file-text"></i> รายการ โอ.ที </a></li>
            <li><a href="<?php echo site_url('leader_approve/index') ?>"><i class="fa fa-user"></i> หัวหน้า </a></li>
